...
in [SKILL.md](../SKILL.md), rather than trying to retrieve or approximate it.

**A second, separate source exists as of [dark-mode-ui-colors.md](./dark-mode-ui-colors.md)**: Medtronic's internal **UI
