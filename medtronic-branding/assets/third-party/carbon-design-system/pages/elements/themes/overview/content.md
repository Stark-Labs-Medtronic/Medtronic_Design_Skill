...
Source: https://www.carbondesignsystem.com/elements/themes/overview/
...
- [Theming basics](https://carbondesignsystem.com/elements/themes/overview/#theming-basics)

- [Customizing a theme](https://carbondesignsystem.com/elements/themes/overview/#customizing-a-theme)

- [Tokens](https://carbondesignsystem.com/elements/themes/overview/#tokens)

- [Theming applied](https://carbondesignsystem.com/elements/themes/overview/#theming-applied)

- [Resources](https://carbondesignsystem.com/elements/themes/overview/#resources)
...
Carbon provides four themes as shown in the [color usage](https://carbondesignsystem.com/elements/color/usage)
...
@use '@carbon/react/scss/themes';@use '@carbon/react/scss/theme' with (  $theme: themes.$g100);Copy to clipboard
...
@use '@carbon/react/scss/theme' with (  $theme: (    background: #e2e2e2,    text-primary: #ffffff,    custom-token-01: #000000,  ));Copy to clipboard
...
[color](https://carbondesignsystem.com/elements/color/overview) page.
...
designs. For more information, see the [spacing](https://carbondesignsystem.com/elements/spacing/overview/)
page.
...
[typography](https://carbondesignsystem.com/elements/typography/overview/) page.
...
```scss
@use '@carbon/react/scss/theme' with (  $theme: (    background: #e2e2e2,    text-primary: #ffffff,    custom-token-01: #000000,  ));
```
