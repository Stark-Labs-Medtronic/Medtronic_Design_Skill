...
Source: https://www.carbondesignsystem.com/elements/2x-grid/usage/
...
- [UI galleries](https://carbondesignsystem.com/elements/2x-grid/usage/#ui-galleries)

- [Fit for purpose](https://carbondesignsystem.com/elements/2x-grid/usage/#fit-for-purpose)

- [Content hierarchy](https://carbondesignsystem.com/elements/2x-grid/usage/#content-hierarchy)

- [Continuity and contrast](https://carbondesignsystem.com/elements/2x-grid/usage/#continuity-and-contrast)

- [Grid influencers](https://carbondesignsystem.com/elements/2x-grid/usage/#grid-influencers)

- [Style models](https://carbondesignsystem.com/elements/2x-grid/usage/#style-models)

- [Gutter modes](https://carbondesignsystem.com/elements/2x-grid/usage/#gutter-modes)

- [Mixing gutter modes](https://carbondesignsystem.com/elements/2x-grid/usage/#mixing-gutter-modes)

- [Using grids in Figma](https://carbondesignsystem.com/elements/2x-grid/usage/#using-grids-in-figma)
...
[mini unit grid](https://carbondesignsystem.com/elements/2x-grid/overview/#mini-unit)) need to be used rather
than fluid columns.
...
Refer back to the [aspect ratios](https://carbondesignsystem.com/elements/2x-grid/overview/#aspect-ratio)
...
[Carbon UI Shell](https://carbondesignsystem.com/components/UI-shell-left-panel/usage/), making the left-hand
...
screens within IBM product use the [2x Grid](https://carbondesignsystem.com/elements/2x-grid/overview/), but
...
[grid influencer](https://carbondesignsystem.com/elements/2x-grid/usage/#grid-influencers) variant of the Carbon UI Shell.
...
Do align components within containers flush to the columns.

Do not hang type into the gutter under any circumstances (note the tabs)
...
Do keep all type (inside and outside containers) aligned with the column grid.

Do not hang type into the gutter under any circumstances.
