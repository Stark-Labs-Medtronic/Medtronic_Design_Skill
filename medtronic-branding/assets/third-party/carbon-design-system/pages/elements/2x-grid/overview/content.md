...
Source: https://www.carbondesignsystem.com/elements/2x-grid/overview/
...
- [Mini unit](https://carbondesignsystem.com/elements/2x-grid/overview/#mini-unit)

- [2x Grid fundamentals](https://carbondesignsystem.com/elements/2x-grid/overview/#2x-grid-fundamentals)

- [Grid behaviors](https://carbondesignsystem.com/elements/2x-grid/overview/#grid-behaviors)

- [Grid influencers](https://carbondesignsystem.com/elements/2x-grid/overview/#grid-influencers)

- [Sizing scale](https://carbondesignsystem.com/elements/2x-grid/overview/#sizing-scale)
...
- [Columns and rows](https://carbondesignsystem.com/elements/2x-grid/overview/#columns-and-rows)

- [Margins](https://carbondesignsystem.com/elements/2x-grid/overview/#margins)

- [Padding](https://carbondesignsystem.com/elements/2x-grid/overview/#padding)

- [Gutters](https://carbondesignsystem.com/elements/2x-grid/overview/#gutters)

- [Breakpoints](https://carbondesignsystem.com/elements/2x-grid/overview/#breakpoints)
...
breakpoint, even when columns are fluid. See [breakpoints](https://carbondesignsystem.com/elements/2x-grid/overview/#breakpoints) for a
...
- [Fluid columns](https://carbondesignsystem.com/elements/2x-grid/overview/#fluid-columns)

- [Fixed boxes](https://carbondesignsystem.com/elements/2x-grid/overview/#fixed-boxes)

- [Hybrid boxes](https://carbondesignsystem.com/elements/2x-grid/overview/#hybrid-boxes)

- [Key lines](https://carbondesignsystem.com/elements/2x-grid/overview/#key-lines)
...
First choose a base size from the [sizing scale](https://carbondesignsystem.com/elements/2x-grid/overview/#sizing-scale), then build up
each box in multiples of the base size, following recommended
[aspect ratios](https://carbondesignsystem.com/elements/2x-grid/overview/#aspect-ratio). A grid emerges when each tile uses a multiple of
...
Use the [sizing scale](https://carbondesignsystem.com/elements/2x-grid/overview/#sizing-scale) to size a fixed dimension. Use
...
- [Screen regions](https://carbondesignsystem.com/elements/2x-grid/overview/#screen-regions)

- [Panel behavior](https://carbondesignsystem.com/elements/2x-grid/overview/#panel-behavior)
...
[Learn more on the Global header pattern page](https://carbondesignsystem.com/patterns/global-header).
...
- [Fixed base unit](https://carbondesignsystem.com/elements/2x-grid/overview/#fixed-base-unit)

- [Fluid base unit](https://carbondesignsystem.com/elements/2x-grid/overview/#fluid-base-unit)

- [Scaling multiple](https://carbondesignsystem.com/elements/2x-grid/overview/#scaling-multiple)

- [Aspect ratio](https://carbondesignsystem.com/elements/2x-grid/overview/#aspect-ratio)

- [Vertical rhythm](https://carbondesignsystem.com/elements/2x-grid/overview/#vertical-rhythm)

- [Components](https://carbondesignsystem.com/elements/2x-grid/overview/#components)
...
[breakpoints table](https://carbondesignsystem.com/elements/2x-grid/overview/#breakpoints).
...
etc. Check out the [breakpoints table](https://carbondesignsystem.com/elements/2x-grid/overview/#breakpoints) for pixel sizings.

### Scaling multiple

After determining your base size, multiply it as needed for each use. For box
sizing, apply an [aspect ratio](https://carbondesignsystem.com/elements/2x-grid/overview/#aspect-ratio) too.
...
In Figma, always use “Auto height” in the Text panel to ensure the text box fits with the content. Spacer snaps to the text box.
