...
Source: https://www.carbondesignsystem.com/elements/color/usage/
...
- [Implementing layering](https://carbondesignsystem.com/elements/color/usage/#implementing-layering)

- [Layering tokens](https://carbondesignsystem.com/elements/color/usage/#layering-tokens)

- [Contextual tokens](https://carbondesignsystem.com/elements/color/usage/#contextual-tokens)

- [Inline theming](https://carbondesignsystem.com/elements/color/usage/#inline-theming)

- [Light or dark mode](https://carbondesignsystem.com/elements/color/usage/#light-or-dark-mode)

## Implementing layering

There are two ways to implement the
[layering model](https://carbondesignsystem.com/elements/color/usage/#layering-tokens) in a theme, either by
...
| Contextual tokens | Abstract code tokens used to automatically map the layering model onto components depending on where it is used on the page. |
...
[migration guide](https://carbondesignsystem.com/migrating/guide/design/).
...
[Tokens](https://carbondesignsystem.com/elements/color/tokens/#layer) tab.
...
<Layer>  <ChildComponent />  <Layer>    <ChildComponent />    <Layer>      <ChildComponent />    </Layer>  </Layer></Layer>Copy to clipboard
...
<Theme theme="g100">  <ChildComponent /></Theme>Copy to clipboard
...
Use light colored assets, tones, and backgrounds for illustrations in the light themes (the best solution)

Use dark colored assets, tones, and backgrounds for illustrations in the dark themes (the best solution)

Don’t use images with colored backgrounds when switching between modes because they will appear broken and in high contrast in the opposite mode

If only one image is available between modes, use an image with a transparent background and swap the container color background to match the mode (acceptable solution)
