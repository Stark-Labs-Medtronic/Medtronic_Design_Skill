# Design kits – Carbon Design System

Source: https://www.carbondesignsystem.com/designing/kits/sketch/
...
- [Get the kit](https://carbondesignsystem.com/designing/kits/sketch/#get-the-kit)

- [Start designing](https://carbondesignsystem.com/designing/kits/sketch/#start-designing)

- [How to use](https://carbondesignsystem.com/designing/kits/sketch/#how-to-use)

- [Explore additional kits](https://carbondesignsystem.com/designing/kits/sketch/#explore-additional-kits)

- [Info](https://carbondesignsystem.com/designing/kits/sketch/#info)
...
There are [four Carbon themes](https://carbondesignsystem.com/elements/color/overview#themes), two light
...
- [Grid](https://carbondesignsystem.com/designing/kits/sketch/#grid)

- [Symbols](https://carbondesignsystem.com/designing/kits/sketch/#symbols)

- [Text styles](https://carbondesignsystem.com/designing/kits/sketch/#text-styles)

- [Layer styles](https://carbondesignsystem.com/designing/kits/sketch/#layer-styles)

### Grid

The [IBM 2x Grid](https://carbondesignsystem.com/elements/2x-grid/overview/) is fundamental to everything we
...
have [saved the grid](https://carbondesignsystem.com/designing/kits/sketch/#get-the-kit) as a template, in
...
page. These [influencers](https://carbondesignsystem.com/elements/2x-grid/overview/#grid-influencers) effect
...
Carbon [components](https://carbondesignsystem.com/components/overview), [add-ons](https://carbondesignsystem.com/contributing/add-ons), and
[icons](https://carbondesignsystem.com/elements/icons/library) live in the design kit as Sketch symbols.
...
our [design guidelines](https://carbondesignsystem.com/guidelines/accessibility/overview).
...
- The first text style level displays [theme options](https://carbondesignsystem.com/elements/themes/overview)
(i.e., white theme).

- The second level shows the [Carbon type](https://carbondesignsystem.com/elements/typography/overview) tokens
(i.e., body-long-01).

- The third level selects the type color, which is labeled with a
[Carbon color](https://carbondesignsystem.com/elements/color/overview) token name.
...
[Color](https://carbondesignsystem.com/elements/color/overview) in Carbon is carefully considered, and we
