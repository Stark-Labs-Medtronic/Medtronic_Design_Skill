...
Source: https://www.carbondesignsystem.com/components/form/usage/
...
the [AI presence](https://carbondesignsystem.com/components/form/usage/#ai-presence) section for more details.

- [Live demo](https://carbondesignsystem.com/components/form/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/form/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/form/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/form/usage/#content)

- [Behaviors](https://carbondesignsystem.com/components/form/usage/#behaviors)

- [Additional guidance](https://carbondesignsystem.com/components/form/usage/#additional-guidance)

- [AI presence](https://carbondesignsystem.com/components/form/usage/#ai-presence)

- [Related](https://carbondesignsystem.com/components/form/usage/#related)

- [Feedback](https://carbondesignsystem.com/components/form/usage/#feedback)
...
[form pattern](https://carbondesignsystem.com/patterns/forms-pattern/#spacing).
...
| Free form inputs | Free-form text inputs are the most commonly used components in forms. They allow a user to enter any configuration of letters or numbers. Common free-form inputs include: text input and text area. |

| Selection controls | Selection controls offer users a selection from pre-determined options. Common selection controls include: checkboxes, radio buttons, file uploaders, toggles, and select lists (combo box and multiselect). |

| Bound entry controls | Bound entry controls allow users to input numeric data, like dates and times and may restrict user input to a certain range. Common bound entry controls include: number input, date picker, and slider components. |
...
| Buttons in forms | Provides guidance on button alignment, emphasis, placement, and naming in relation to a form. |

| Errors and validation | Effective and immediate error messaging can help the user to understand the problem and how to fix it. |

| Form layout | Additional guidance around layout, spacing, and columns in a form. |
