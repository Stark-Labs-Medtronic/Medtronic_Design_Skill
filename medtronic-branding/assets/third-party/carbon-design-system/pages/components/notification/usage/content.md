...
Source: https://www.carbondesignsystem.com/components/notification/usage/
...
- [Live demo](https://carbondesignsystem.com/components/notification/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/notification/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/notification/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/notification/usage/#content)

- [Inline](https://carbondesignsystem.com/components/notification/usage/#inline)

- [Toast](https://carbondesignsystem.com/components/notification/usage/#toast)

- [Actionable](https://carbondesignsystem.com/components/notification/usage/#actionable)

- [Callout](https://carbondesignsystem.com/components/notification/usage/#callout)

- [Universal behaviors](https://carbondesignsystem.com/components/notification/usage/#universal-behaviors)

- [Modifiers](https://carbondesignsystem.com/components/notification/usage/#modifiers)

- [Related](https://carbondesignsystem.com/components/notification/usage/#related)

- [Feedback](https://carbondesignsystem.com/components/notification/usage/#feedback)
...
refer to the [notifications pattern](https://carbondesignsystem.com/patterns/notification-pattern/). Carbon
...
| Toast | Toast notifications are non-modal, time-based window elements used to display short messages; they usually appear at the top of the screen and disappear after a few seconds. |
...
| Callout | Callouts are used to highlight important information that loads with the contents of the page, is placed contextually, and cannot be dismissed. |
...
information, refer to the [Code](https://carbondesignsystem.com/components/notification/code/) tab. The
...
inline styling, refer to [inline notifications](https://carbondesignsystem.com/components/notification/usage/#inline-notifications) for
...
[toast notifications](https://carbondesignsystem.com/components/notification/usage/#toast-notifications).
