...
Source: https://www.carbondesignsystem.com/components/pagination/usage/
...
- [Live demo](https://carbondesignsystem.com/components/pagination/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/pagination/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/pagination/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/pagination/usage/#content)

- [Pagination](https://carbondesignsystem.com/components/pagination/usage/#pagination)

- [Pagination nav](https://carbondesignsystem.com/components/pagination/usage/#pagination-nav)

- [Modifiers](https://carbondesignsystem.com/components/pagination/usage/#modifiers)

- [Related](https://carbondesignsystem.com/components/pagination/usage/#related)

- [Feedback](https://carbondesignsystem.com/components/pagination/usage/#feedback)
...
| Pagination | The pagination variant is typically connected at the bottom of the data table component to help paginate large amounts of data. |

| Pagination nav | The pagination nav variant is mainly used in on-page situations to help paginate either a whole page or sections of a page. |
