...
Source: https://www.carbondesignsystem.com/components/list/usage/
...
- [Live demo](https://carbondesignsystem.com/components/list/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/list/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/list/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/list/usage/#content)

- [Unordered list](https://carbondesignsystem.com/components/list/usage/#unordered-list)

- [Ordered list](https://carbondesignsystem.com/components/list/usage/#ordered-list)

- [Related](https://carbondesignsystem.com/components/list/usage/#related)

- [Feedback](https://carbondesignsystem.com/components/list/usage/#feedback)
...
[data table](https://carbondesignsystem.com/components/data-table/usage/) instead.

- If a basic hierarchy with tables or dividers is required, use the
[structured list](https://carbondesignsystem.com/components/structured-list/usage/) or
[contained list](https://carbondesignsystem.com/components/contained-list/usage/) components instead.
...
| Unordered list | Used to display items of equal importance without a specific order. |

| Ordered list | Use to indicate a clear sequence or hierarchy, often used for instructions. |
...
using a [data table](https://carbondesignsystem.com/components/data-table/usage) instead.
