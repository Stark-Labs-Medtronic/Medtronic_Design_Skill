...
Source: https://www.carbondesignsystem.com/components/UI-shell-header/usage/
...
- [Live demo](https://carbondesignsystem.com/components/UI-shell-header/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/UI-shell-header/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/UI-shell-header/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/UI-shell-header/usage/#content)

- [Behaviors](https://carbondesignsystem.com/components/UI-shell-header/usage/#behaviors)

- [Related](https://carbondesignsystem.com/components/UI-shell-header/usage/#related)

- [References](https://carbondesignsystem.com/components/UI-shell-header/usage/#references)

- [Feedback](https://carbondesignsystem.com/components/UI-shell-header/usage/#feedback)
...
[left panel](https://carbondesignsystem.com/components/UI-shell-left-panel/usage), and the
...
| Header with sidenav | The header can be paired with the UI shell left panel to offer a deeper level of navigation in a UI. |
...
such as the [left panel.](https://carbondesignsystem.com/components/UI-shell-left-panel/usage) The
