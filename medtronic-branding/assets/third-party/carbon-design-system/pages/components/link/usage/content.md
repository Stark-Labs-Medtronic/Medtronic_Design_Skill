...
Source: https://www.carbondesignsystem.com/components/link/usage/
...
- [Live demo](https://carbondesignsystem.com/components/link/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/link/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/link/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/link/usage/#content)

- [Universal behaviors](https://carbondesignsystem.com/components/link/usage/#universal-behaviors)

- [Standalone link](https://carbondesignsystem.com/components/link/usage/#standalone-link)

- [Inline link](https://carbondesignsystem.com/components/link/usage/#inline-link)

- [Modifiers](https://carbondesignsystem.com/components/link/usage/#modifiers)

- [Related](https://carbondesignsystem.com/components/link/usage/#related)

- [Reference](https://carbondesignsystem.com/components/link/usage/#reference)

- [Feedback](https://carbondesignsystem.com/components/link/usage/#feedback)
...
| Standalone | Used on their own or directly following content and do not use underlines. They can be paired with an icon. |

| Inline | Used within a sentence or paragraph and is styled with an underline. They should not be paired with an icon. |
