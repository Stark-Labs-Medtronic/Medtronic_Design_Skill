...
Source: https://www.carbondesignsystem.com/components/tree-view/usage/
...
- [Live demo](https://carbondesignsystem.com/components/tree-view/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/tree-view/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/tree-view/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/tree-view/usage/#content)

- [Behaviors](https://carbondesignsystem.com/components/tree-view/usage/#behaviors)

- [Related](https://carbondesignsystem.com/components/tree-view/usage/#related)

- [References](https://carbondesignsystem.com/components/tree-view/usage/#references)

- [Feedback](https://carbondesignsystem.com/components/tree-view/usage/#feedback)
...
different component like the [accordion](https://carbondesignsystem.com/components/accordion/usage/) or
[data table](https://carbondesignsystem.com/components/data-table/usage/) for expandable views that go one
level deep.
...
[UI shell left panel](https://carbondesignsystem.com/components/UI-shell-left-panel/usage/) and the
[breadcrumb](https://carbondesignsystem.com/components/breadcrumb/usage/) component can support an
information architecture several levels deep.

### Feature flags

A [feature flag](https://carbondesignsystem.com/components/overview/feature-flags/) has been added to tree
...
[Code](https://carbondesignsystem.com/components/tree-view/code/) tab. The current tree view is not being
...
[positioning](https://carbondesignsystem.com/patterns/overflow-content/#variations) the ellipsis at the
...
Use the [accordion](https://carbondesignsystem.com/accordion/usage/) component when you need to organize
...
Use the [UI Shell left panel](https://carbondesignsystem.com/UI-shell-left-panel/usage/) component for product
navigation. A combination of the UI Shell left panel and the
[breadcrumb](https://carbondesignsystem.com/components/breadcrumb/usage/) component can support an information
...
Use the [data table](https://carbondesignsystem.com/components/data-table/usage/) component for displaying
