...
Source: https://www.carbondesignsystem.com/components/text-input/usage/
...
the components. See the [AI presence](https://carbondesignsystem.com/components/text-input/usage/#ai-presence)
section for more details.

- [Live demo](https://carbondesignsystem.com/components/text-input/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/text-input/usage/#overview)
...
- [Formatting](https://carbondesignsystem.com/components/text-input/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/text-input/usage/#content)

- [Universal behaviors](https://carbondesignsystem.com/components/text-input/usage/#universal-behaviors)

- [Modifiers](https://carbondesignsystem.com/components/text-input/usage/#modifiers)

- [AI Presence](https://carbondesignsystem.com/components/text-input/usage/#ai-presence)

- [Related](https://carbondesignsystem.com/components/text-input/usage/#related)

- [Feedback](https://carbondesignsystem.com/components/text-input/usage/#feedback)
...
| Focus | When a user tabs to or clicks on the text input or text area, it becomes focused, indicating the user has successfully navigated to the component. |
...
the [form pattern](https://carbondesignsystem.com/patterns/forms-pattern/#optional-vs.-mandatory).
...
[accessibility tab](https://carbondesignsystem.com/components/text-input/accessibility).
