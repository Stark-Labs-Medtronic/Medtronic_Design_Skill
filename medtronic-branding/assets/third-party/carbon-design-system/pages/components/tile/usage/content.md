...
Source: https://www.carbondesignsystem.com/components/tile/usage/
...
- [Live demo](https://carbondesignsystem.com/components/tile/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/tile/usage/#overview)

- [Variants](https://carbondesignsystem.com/components/tile/usage/#variants)

- [Formatting](https://carbondesignsystem.com/components/tile/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/tile/usage/#content)

- [Base](https://carbondesignsystem.com/components/tile/usage/#base)

- [Clickable](https://carbondesignsystem.com/components/tile/usage/#clickable)

- [Selectable](https://carbondesignsystem.com/components/tile/usage/#selectable)

- [Expandable](https://carbondesignsystem.com/components/tile/usage/#expandable)

- [AI presence](https://carbondesignsystem.com/components/tile/usage/#ai-presence)

- [Related](https://carbondesignsystem.com/components/tile/usage/#related)

- [References](https://carbondesignsystem.com/components/tile/usage/#references)

- [Feedback](https://carbondesignsystem.com/components/tile/usage/#feedback)
...
actions, or notifications. Use [modals](https://carbondesignsystem.com/components/modal/usage),
[popovers](https://carbondesignsystem.com/components/popover/usage), and
...
| Clickable | For prompting an action, navigating or directing to other pieces of information about the subject matter. This variant has an available feature flag. |

| Selectable | For presenting options to a user in a structured manner, such as a set of pricing plans. This variant has available feature flags. |

| Expandable | For hiding and revealing a large amount of content to focus on specific pieces of information. This variant has an available feature flag. |
...
feature flag information, refer to the [Code](https://carbondesignsystem.com/components/tile/code/) tab. These
...
calls-to-action (CTAs), such as a [buttons](https://carbondesignsystem.com/components/button/usage) or
[links](https://carbondesignsystem.com/components/link/usage).
...
[2x grid](https://carbondesignsystem.com/elements/2x-grid/implementation).
