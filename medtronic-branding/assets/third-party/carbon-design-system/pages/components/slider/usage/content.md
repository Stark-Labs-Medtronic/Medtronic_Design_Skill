...
Source: https://www.carbondesignsystem.com/components/slider/usage/
...
- [Live demo](https://carbondesignsystem.com/components/slider/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/slider/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/slider/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/slider/usage/#content)

- [Behaviors](https://carbondesignsystem.com/components/slider/usage/#behaviors)

- [Default slider](https://carbondesignsystem.com/components/slider/usage/#default-slider)

- [Range slider](https://carbondesignsystem.com/components/slider/usage/#range-slider)

- [Modifiers](https://carbondesignsystem.com/components/slider/usage/#modifiers)

- [Feedback](https://carbondesignsystem.com/components/slider/usage/#feedback)
...
| Default slider | Default sliders allow users to select a single value within the slider track. |

| Range slider | Range sliders allow users to define minimum and maximum values from a predefined range within the slider track. |
