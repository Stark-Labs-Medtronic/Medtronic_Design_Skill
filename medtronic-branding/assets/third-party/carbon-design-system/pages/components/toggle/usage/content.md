...
Source: https://www.carbondesignsystem.com/components/toggle/usage/
...
- [Live demo](https://carbondesignsystem.com/components/toggle/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/toggle/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/toggle/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/toggle/usage/#content)

- [Behaviors](https://carbondesignsystem.com/components/toggle/usage/#behaviors)

- [Default toggle](https://carbondesignsystem.com/components/toggle/usage/#default-toggle)

- [Small toggle](https://carbondesignsystem.com/components/toggle/usage/#small-toggle)

- [Related](https://carbondesignsystem.com/components/toggle/usage/#related)

- [Feedback](https://carbondesignsystem.com/components/toggle/usage/#feedback)
...
[radio button](https://carbondesignsystem.com/components/radio-button/usage/), or
...
combination with a [button](https://carbondesignsystem.com/components/button/usage/).
...
| Default toggle | Use the default toggle when you need to specify a label text in addition to the toggle state text. Default toggles appear in forms or within full pages of information. |

| Small toggle | Use the small toggle when you do not need to specify label or state text. Small toggles are more compact in size and are used inline with other components. |
...
[Code](https://carbondesignsystem.com/components/toggle/code/) tab. The current toggle is not being
...
[Style](https://carbondesignsystem.com/components/toggle/style/) tab.
...
[data table](https://carbondesignsystem.com/components/data-table/usage) rows.
