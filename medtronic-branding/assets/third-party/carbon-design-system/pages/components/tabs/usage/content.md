...
Source: https://www.carbondesignsystem.com/components/tabs/usage/
...
- [Live demo](https://carbondesignsystem.com/components/tabs/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/tabs/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/tabs/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/tabs/usage/#content)

- [Universal behaviors](https://carbondesignsystem.com/components/tabs/usage/#universal-behaviors)

- [Line tabs](https://carbondesignsystem.com/components/tabs/usage/#line-tabs)

- [Contained tabs](https://carbondesignsystem.com/components/tabs/usage/#contained-tabs)

- [Vertical tabs](https://carbondesignsystem.com/components/tabs/usage/#vertical-tabs)

- [Modifiers](https://carbondesignsystem.com/components/tabs/usage/#modifiers)

- [Related](https://carbondesignsystem.com/components/tabs/usage/#related)

- [References](https://carbondesignsystem.com/components/tabs/usage/#references)

- [Feedback](https://carbondesignsystem.com/components/tabs/usage/#feedback)
...
same content, use [content switcher](https://carbondesignsystem.com/components/content-switcher/usage)
...
[progress indicator](https://carbondesignsystem.com/components/progress-indicator/usage). Tabs help organize
...
| Line | A standalone tab that can also be nested within components. It is commonly used within components or for content using the entire page for layout, not connected to any other components. |

| Contained | An emphasized tab that is commonly used for defined content areas. |

| Vertical | A tablist with a vertical orientation to browse through content. |
