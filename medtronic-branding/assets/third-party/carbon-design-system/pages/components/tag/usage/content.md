...
Source: https://www.carbondesignsystem.com/components/tag/usage/
...
- [Live demo](https://carbondesignsystem.com/components/tag/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/tag/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/tag/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/tag/usage/#content)

- [Behaviors](https://carbondesignsystem.com/components/tag/usage/#behaviors)

- [Read-only tag](https://carbondesignsystem.com/components/tag/usage/#read-only-tag)

- [Dismissible tag](https://carbondesignsystem.com/components/tag/usage/#dismissible-tag)

- [Selectable tag](https://carbondesignsystem.com/components/tag/usage/#selectable-tag)

- [Operational tag](https://carbondesignsystem.com/components/tag/usage/#operational-tag)

- [Modifiers](https://carbondesignsystem.com/components/tag/usage/#modifiers)

- [AI presence](https://carbondesignsystem.com/components/tag/usage/#ai-presence)

- [References](https://carbondesignsystem.com/components/tag/usage/#references)

- [Feedback](https://carbondesignsystem.com/components/tag/usage/#feedback)
...
| Read-only tag | Tags that have no interactive functionality and are commonly used for categorizing and labeling. |

| Dismissible tag | Tags that can be dismissed, closed, or removed. These tags are typically used for filtering and creating user-generated content. |

| Selectable tag | Tags that can be selected or deselected and are frequently used as selections that filter data in the context of a page. They also can be used in chat flows to make decisions to advance the chat. |

| Operational tag | When interacted with, these tags can disclose additional or overflow tags, like in a popover, modal, or breadcrumb detail view. |
