...
Source: https://www.carbondesignsystem.com/components/data-table/usage/
...
the [AI presence](https://carbondesignsystem.com/components/data-table/usage/#ai-presence) section for more
details.

- [Live demo](https://carbondesignsystem.com/components/data-table/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/data-table/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/data-table/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/data-table/usage/#content)

- [Variants](https://carbondesignsystem.com/components/data-table/usage/#variants)

- [Universal behaviors](https://carbondesignsystem.com/components/data-table/usage/#universal-behaviors)

- [Modifiers](https://carbondesignsystem.com/components/data-table/usage/#modifiers)

- [AI presence](https://carbondesignsystem.com/components/data-table/usage/#ai-presence)

- [Related](https://carbondesignsystem.com/components/data-table/usage/#related)

- [Feedback](https://carbondesignsystem.com/components/data-table/usage/#feedback)
...
[gutter modes](https://carbondesignsystem.com/elements/2x-grid/usage/#gutter-modes) outlined in the 2x grid
...
[sentence-case capitalization.](https://carbondesignsystem.com/guidelines/content/writing-style#use-sentence-case-capitalization)
...
[primary button](https://carbondesignsystem.com/components/button/usage#labels) usage and
[action labels.](https://carbondesignsystem.com/guidelines/content/action-labels)
...
[table toolbar](https://carbondesignsystem.com/components/data-table/usage/#table-toolbar) or
[batch action mode](https://carbondesignsystem.com/components/data-table/usage/#batch-actions).
...
See the [Accessibility](https://carbondesignsystem.com/components/data-table/accessibility/) tab for more
information.
...
information, see the [pagination](https://carbondesignsystem.com/components/pagination/usage) component.
...
[active search](https://carbondesignsystem.com/patterns/search-pattern/#active-search) pattern. The search is
...
- [Accordion](https://carbondesignsystem.com/components/accordion/code/)

- [List](https://carbondesignsystem.com/components/list/code/)

- [Pagination](https://carbondesignsystem.com/components/pagination/code/)

- [Structured list](https://carbondesignsystem.com/components/structured-list/code/)
