...
Source: https://www.carbondesignsystem.com/components/date-picker/usage/
...
the [AI presence](https://carbondesignsystem.com/components/date-picker/usage/#ai-presence) section for more
details.

- [Live demo](https://carbondesignsystem.com/components/date-picker/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/date-picker/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/date-picker/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/date-picker/usage/#content)

- [Universal behaviors](https://carbondesignsystem.com/components/date-picker/usage/#universal-behaviors)

- [Simple date input](https://carbondesignsystem.com/components/date-picker/usage/#simple-date-input)

- [Calendar pickers](https://carbondesignsystem.com/components/date-picker/usage/#calendar-pickers)

- [Time pickers](https://carbondesignsystem.com/components/date-picker/usage/#time-pickers)

- [AI presence](https://carbondesignsystem.com/components/date-picker/usage/#ai-presence)

- [Related](https://carbondesignsystem.com/components/date-picker/usage/#related)

- [Feedback](https://carbondesignsystem.com/components/date-picker/usage/#feedback)
...
[calendar variants](https://carbondesignsystem.com/components/date-picker/usage#calendar-variants) for
specific day styles.
...
The date picker input is a [text input](https://carbondesignsystem.com/components/text-input/usage) and has
...
[style tab](https://carbondesignsystem.com/components/date-picker/style#date-picker-color) for more details.
For calendar menu states, see the
[calendar variants](https://carbondesignsystem.com/components/date-picker/usage/#calendar-variants) section.

#### Time picker

The time picker is a combination of a [text input](https://carbondesignsystem.com/components/text-input/usage)
and [select inputs](https://carbondesignsystem.com/components/select/usage) and has the same interactive state
and behaviors. See the
[style tab](https://carbondesignsystem.com/components/date-picker/style/#time-picker-color) for more details.
...
made by using the standard [select](https://carbondesignsystem.com/components/select/usage/) component.
