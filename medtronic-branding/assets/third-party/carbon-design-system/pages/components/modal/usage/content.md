...
Source: https://www.carbondesignsystem.com/components/modal/usage/
...
the [AI presence](https://carbondesignsystem.com/components/modal/usage/#ai-presence) section for more
details.

- [Live demo](https://carbondesignsystem.com/components/modal/usage/#live-demo)

- [Overview](https://carbondesignsystem.com/components/modal/usage/#overview)

- [Formatting](https://carbondesignsystem.com/components/modal/usage/#formatting)

- [Content](https://carbondesignsystem.com/components/modal/usage/#content)

- [Universal behaviors](https://carbondesignsystem.com/components/modal/usage/#universal-behaviors)

- [Modal variants](https://carbondesignsystem.com/components/modal/usage/#modal-variants)

- [AI presence](https://carbondesignsystem.com/components/modal/usage/#ai-presence)

- [Related](https://carbondesignsystem.com/components/modal/usage/#related)

- [Feedback](https://carbondesignsystem.com/components/modal/usage/#feedback)
...
Modals are a type of [dialog](https://carbondesignsystem.com/patterns/dialog-pattern) because it is a
...
A [feature flag](https://carbondesignsystem.com/components/overview/feature-flags/) was added to the modal
...
[Code](https://carbondesignsystem.com/components/modal/code/) tab. The current modal is not being deprecated,
...
There are four responsive [modal sizes](https://carbondesignsystem.com/components/modal/style#sizes): extra
...
[maximum height](https://carbondesignsystem.com/components/modal/style#max-sizes). If your modal has too much
...
In a modal that has [larger breakpoints](https://carbondesignsystem.com/components/modal/style#margin-right),
...
period is needed, a [loading spinner](https://carbondesignsystem.com/components/loading/usage) and overlay
...
[inline loading](https://carbondesignsystem.com/patterns/loading-pattern#inline-loading) behavior on the
...
[transactional modal](https://carbondesignsystem.com/components/modal/usage#transactional-modal) used for
