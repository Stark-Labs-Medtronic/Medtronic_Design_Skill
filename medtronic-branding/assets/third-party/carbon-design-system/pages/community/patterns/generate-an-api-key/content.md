...
Source: https://www.carbondesignsystem.com/community/patterns/generate-an-api-key/
...
- [General access keys](https://carbondesignsystem.com/community/patterns/generate-an-api-key/#general-access-keys)

- [Restricted access keys](https://carbondesignsystem.com/community/patterns/generate-an-api-key/#restricted-access-keys)

- [Show the API key in context (optional)](https://carbondesignsystem.com/community/patterns/generate-an-api-key/#show-the-api-key-in-context-(optional))

- [API key management page (optional)](https://carbondesignsystem.com/community/patterns/generate-an-api-key/#api-key-management-page-(optional))

- [Edit an API key (optional)](https://carbondesignsystem.com/community/patterns/generate-an-api-key/#edit-an-api-key-(optional))
