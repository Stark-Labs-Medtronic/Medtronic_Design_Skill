...
Source: https://www.carbondesignsystem.com/migrating/guide/develop/

# Guide

Step-by-step guide to updating your code from Carbon v10 to v11.

- [Overview](https://carbondesignsystem.com/migrating/guide/develop/#overview)

- [Migrating a React app or library](https://carbondesignsystem.com/migrating/guide/develop/#migrating-a-react-app-or-library)

- [Migrating an app or library using just styles](https://carbondesignsystem.com/migrating/guide/develop/#migrating-an-app-or-library-using-just-styles)

- [Migrating carbon-icons](https://carbondesignsystem.com/migrating/guide/develop/#migrating-carbon-icons)

- [Migrating Carbon elements](https://carbondesignsystem.com/migrating/guide/develop/#migrating-carbon-elements)
...
[Migrating a React app](https://carbondesignsystem.com/migrating/guide/develop/#migrating-a-react-app) section.
...
[deprecated](https://carbondesignsystem.com/deprecations).
...
npm uninstall carbon-components carbon-components-react carbon-icons @carbon/icons-reactCopy to clipboard
...
yarn remove carbon-components carbon-components-react carbon-icons @carbon/icons-reactCopy to clipboard
...
npm install @carbon/reactCopy to clipboard
...
npx @carbon/upgrade migrate update-carbon-components-react-import-to-scoped --writeCopy to clipboard
...
// Beforeimport { Accordion, AccordionItem } from 'carbon-components-react';// Afterimport { Accordion, AccordionItem } from '@carbon/react';Copy to clipboard
...
npm uninstall node-sassCopy to clipboard
...
yarn remove node-sassCopy to clipboard
...
npm install sass --save-devCopy to clipboard
...
yarn add sass --devCopy to clipboard
...
- @import 'carbon-components/scss/globals/scss/styles.scss';+ @use '@carbon/react';Copy to clipboard
...
@use '@carbon/react' with (  $css--default-type: true,  $css--reset: true);Copy to clipboard
...
// Configure feature flags if needed, if not these// lines can be removed@use '@carbon/react/scss/config' with (  $font-path: '@ibm/plex',  $use-flexbox-grid: 'true');
// Emit the css reset@use '@carbon/react/scss/reset';Copy to clipboardShow more
...
- @include carbon--breakpoint(lg) {+ @include breakpoint(lg) {      width: 42%;  }Copy to clipboard
...
npx @carbon/upgrade migrate small-to-size-prop --writenpx @carbon/upgrade migrate size-prop-update --writeCopy to clipboard
...
npx @carbon/upgrade migrate icons-react-size-prop --writenpx @carbon/upgrade migrate update-carbon-icons-react-import-to-carbon-react --writeCopy to clipboard
...
function MyComponent() {  return (    <>      <Add32 />      <Add24 />      <Add20 />      <Add16 />Copy to clipboardShow more
...
function MyComponent() {  return (    <>      <Add size={32} />      <Add size={24} />      <Add size={20} />      <Add />Copy to clipboardShow more
...
function MyComponent({ renderIcon: Icon }) {  const ref = useRef(null);  return <Icon ref={ref} />;}
// Before<MyComponent renderIcon={Search16} />
// After the codemodCopy to clipboardShow more
...
<MyComponent  renderIcon={React.forwardRef((props, ref) => (    <Search ref={ref} size={16} {...props} />  ))}/>;
// Or, alternatively:const Search16 = React.forwardRef((props, ref) => {  return <Search ref={ref} size={16} {...props} />;Copy to clipboardShow more
...
<Tabs>  <Tab label="Tab label 1">    <p>Content for first tab goes here.</p>  </Tab>  <Tab label="Tab label 2">    <p>Content for second tab goes here.</p>  </Tab>  <Tab label="Tab label 3" disabled>    <p>Content for third tab goes here.</p>Copy to clipboardShow more
...
<Tabs>  <TabList>    <Tab>Tab Label 1</Tab>    <Tab>Tab Label 2</Tab>    <Tab disabled>Tab Label 3</Tab>    <Tab title="Tab Label 4 shows truncation">Tab Label 4 shows truncation</Tab>  </TabList>  <TabPanels>    <TabPanel>Content for first tab goes here.</TabPanel>Copy to clipboardShow more
...
npm uninstall carbon-componentsCopy to clipboard
...
yarn remove carbon-componentsCopy to clipboard
...
npm install @carbon/stylesCopy to clipboard
...
yarn add @carbon/stylesCopy to clipboard
...
npm install sassCopy to clipboard
...
yarn add sassCopy to clipboard
...
- @import 'carbon-components/scss/globals/scss/styles.scss';+ @use '@carbon/styles';Copy to clipboard
...
@use '@carbon/styles' with (  $css--default-type: true,  $css--reset: true);Copy to clipboard
...
// configure feature flags if needed, if not this line can be removed@use '@carbon/styles/scss/config' with (  $font-path: '@ibm/plex');
// ensure the css reset is included@use '@carbon/styles/scss/reset';
// add styles for components individuallyCopy to clipboardShow more
...
// Option A@use '@carbon/styles' with (  $prefix: 'bx');// Option B@use '@carbon/styles/scss/config' with (  $prefix: 'bx');Copy to clipboard
...
@use '@carbon/styles/scss/grid/flexbox';Copy to clipboard
...
npm install @carbon/<package-name>@latestCopy to clipboard
...
yarn upgrade @carbon/<package-name>@latestCopy to clipboard
...
```scss
// Configure feature flags if needed, if not these// lines can be removed@use '@carbon/react/scss/config' with (  $font-path: '@ibm/plex',  $use-flexbox-grid: 'true');
// Emit the css reset@use '@carbon/react/scss/reset';
```
...
```jsx
import { Add32, Add24, Add20, Add16 } from '@carbon/icons-react';
function MyComponent() {  return (    <>      <Add32 />      <Add24 />      <Add20 />      <Add16 />
```
...
```jsx
import { Add } from '@carbon/react/icons';
function MyComponent() {  return (    <>      <Add size={32} />      <Add size={24} />      <Add size={20} />      <Add />
```
...
```jsx
<MyComponent  renderIcon={React.forwardRef((props, ref) => (    <Search ref={ref} size={16} {...props} />  ))}/>;
// Or, alternatively:const Search16 = React.forwardRef((props, ref) => {  return <Search ref={ref} size={16} {...props} />;
```
