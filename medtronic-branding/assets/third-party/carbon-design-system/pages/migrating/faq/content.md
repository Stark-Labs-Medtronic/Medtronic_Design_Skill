...
Source: https://www.carbondesignsystem.com/migrating/faq/

# FAQs

- [General](https://carbondesignsystem.com/migrating/faq/#general)

- [Sass and package management](https://carbondesignsystem.com/migrating/faq/#sass-and-package-management)

- [Additional resources](https://carbondesignsystem.com/migrating/faq/#additional-resources)
...
process. For additional migration steps, head [here](https://carbondesignsystem.com/design#kit-migration).
...
@use '@carbon/react';Copy to clipboard
...
@use '@carbon/react/scss/components/[componentname]';Copy to clipboard
...
//overriding theme tokens and adding a custom token@use '@carbon/react/scss/theme' with (  $theme: (    // add a completely new token    custom-token: #bada44,    // redefine existing tokens to new values    text-error: rebeccapurple,Copy to clipboardShow more
...
.some-class {  background: $layer;}Copy to clipboard
...
.some-class {  background: theme.$layer;}Copy to clipboard
...
```scss
@use '@carbon/react/scss/themes' as *;
//overriding theme tokens and adding a custom token@use '@carbon/react/scss/theme' with (  $theme: (    // add a completely new token    custom-token: #bada44,    // redefine existing tokens to new values    text-error: rebeccapurple,
```
...
```scss
@use '@carbon/react/scss/theme';
.some-class {  background: theme.$layer;}
```
