...
Source: https://www.carbondesignsystem.com/all-about-carbon/who-uses-carbon/
...
- [Designers](https://carbondesignsystem.com/all-about-carbon/who-uses-carbon/#designers)

- [Developers](https://carbondesignsystem.com/all-about-carbon/who-uses-carbon/#developers)

- [Marketers](https://carbondesignsystem.com/all-about-carbon/who-uses-carbon/#marketers)

- [Product managers](https://carbondesignsystem.com/all-about-carbon/who-uses-carbon/#product-managers)

- [Sales](https://carbondesignsystem.com/all-about-carbon/who-uses-carbon/#sales)

- [Support](https://carbondesignsystem.com/all-about-carbon/who-uses-carbon/#support)
...
[foundational elements](https://carbondesignsystem.com/elements/2x-grid/overview), their usage
...
[components](https://carbondesignsystem.com/components/overview/components/) and
[patterns](https://carbondesignsystem.com/patterns/overview/).

- Check out [design tutorials](https://carbondesignsystem.com/designing/get-started/) to learn more about some
of the foundational pieces of the design system.

#### Get the tools

- Visit the [Get started](https://carbondesignsystem.com/designing/get-started/) page to install the Figma
design kits.

- Visit the [Other resources](https://carbondesignsystem.com/designing/design-resources/) page to find other
useful tools and plugins.

#### Connect with the team

- Find [meetups](https://carbondesignsystem.com/whats-happening/meetups/) for leveling up your skills,
...
- [Contribute](https://carbondesignsystem.com/contributing/get-started/overview/) component and/or pattern
enhancements, or create new assets, stewarded by the Carbon team.

- Author usage documentation for
[patterns](https://carbondesignsystem.com/contributing/documentation/#documenting-patterns) and
[components](https://carbondesignsystem.com/contributing/documentation/#documenting-components).
...
[Carbon foundational elements](https://carbondesignsystem.com/elements/2x-grid/overview/), the usage
documentation, and the system’s
[design principles](https://www.ibm.com/design/language/).

- Check out a tutorial in your framework of choice
[React using Next.js](https://carbondesignsystem.com/developing/react-tutorial/overview/),
([Web components using Vanilla.js/HTML](https://carbondesignsystem.com/developing/web-components-tutorial/overview/),
[Angular (community)](https://carbondesignsystem.com/developing/angular-tutorial/overview/) or
[Vue (community)](https://carbondesignsystem.com/developing/vue-tutorial/overview/)).

#### Get the tools

- Visit [Developing > Get started](https://carbondesignsystem.com/developing/get-started/) and install your
framework of choice.

- Visit [Developer resources](https://carbondesignsystem.com/developing/dev-resources/resources/) to find
...
- [Contribute](https://carbondesignsystem.com/contributing/get-started/overview/) component and pattern
enhancements or create new assets, stewarded by the Carbon team.
...
- Stay current with Carbon’s [releases and roadmap](https://carbondesignsystem.com/all-about-carbon/releases/)
...
- Stay up to date with Carbon’s
[roadmap and releases](https://carbondesignsystem.com/all-about-carbon/releases/).
