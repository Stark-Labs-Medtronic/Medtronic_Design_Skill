...
Source: https://www.carbondesignsystem.com/developing/vue-tutorial/step-1/
...
- [Fork, clone and branch](https://carbondesignsystem.com/developing/vue-tutorial/step-1/#fork-clone-and-branch)

- [Build and start](https://carbondesignsystem.com/developing/vue-tutorial/step-1/#build-and-start)

- [Install Carbon](https://carbondesignsystem.com/developing/vue-tutorial/step-1/#install-carbon)

- [Other dependencies](https://carbondesignsystem.com/developing/vue-tutorial/step-1/#other-dependencies)

- [Add UI Shell](https://carbondesignsystem.com/developing/vue-tutorial/step-1/#add-ui-shell)

- [Create pages](https://carbondesignsystem.com/developing/vue-tutorial/step-1/#create-pages)

- [Add routing](https://carbondesignsystem.com/developing/vue-tutorial/step-1/#add-routing)

- [Submit pull request](https://carbondesignsystem.com/developing/vue-tutorial/step-1/#submit-pull-request)
...
git clone [your fork SSH/HTTPS]cd carbon-tutorial-vueCopy to clipboard
...
git remote add upstream git@github.com:carbon-design-system/carbon-tutorial-vue.gitCopy to clipboard
...
git remote add upstream https://github.com/carbon-design-system/carbon-tutorial-vue.gitCopy to clipboard
...
origin	[your forked repo] (fetch)origin	[your forked repo] (push)upstream	git@github.com:carbon-design-system/carbon-tutorial-vue.git (fetch)upstream	git@github.com:carbon-design-system/carbon-tutorial-vue.git (push)Copy to clipboard
...
git fetch upstreamgit checkout -b vue-step-1 upstream/vue-step-1Copy to clipboard
...
yarn add carbon-components @carbon/vue @carbon/icons-vueCopy to clipboard
...
.envCopy to clipboardSASS_PATH="node_modules"
...
src/App.vueCopy to clipboard<style lang="scss">@import "./styles/carbon";</style>
...
src/styles/_carbon.scssCopy to clipboard@import 'carbon-components/scss/globals/scss/styles';
...
src/main.jsCopy to clipboardimport CarbonComponentsVue from "@carbon/vue";Vue.use(CarbonComponentsVue);
...
src/App.vueCopy to clipboard<script>import { CvButton } from '@carbon/vue';
export default {  components: {    CvButton,  }};</script>
...
src/App.vueCopy to clipboard  Hello Carbon! Well, not quite yet. This is the starting point for the Carbon tutorial.
...
src/App.vueCopy to clipboard<CvButton>Button</CvButton>
...
<cv-button>Button</cv-button>Copy to clipboard
...
src/components/TutorialHeader├──index.js└──TutorialHeader.vueCopy to clipboard
...
src/components/TutorialHeader/index.jsCopy to clipboardimport TutorialHeader from './TutorialHeader';export default TutorialHeader;
...
javascript.jsonCopy to clipboard  "index-file": {    "prefix": "index",    "body": [      "import ${TM_DIRECTORY/.*[\\/]//gm} from './${TM_DIRECTORY/.*[\\/]//gm}';",      "export { ",      "\t${TM_DIRECTORY/.*[\\/]//gm},",      "};",      "export default ${TM_DIRECTORY/.*[\\/]//gm}",      ""Show more
...
vue.jsonCopy to clipboard  "Vue_Component": {    "prefix": "template",    "body": [      "<template>",      "\t$0",      "</template>",      "",      "<script>",      "export default {",Show more
...
src/components/TutorialHeader/TutorialHeader.vueCopy to clipboard<template>  <cv-header aria-label="Carbon tutorial">    <cv-skip-to-content href="#main-content"      >Skip to content</cv-skip-to-content    >
    <cv-header-name href="/" prefix="IBM">Carbon Tutorial</cv-header-name>
    <cv-header-nav>Show more
...
src/components/TutorialHeader/TutorialHeader.vueCopy to clipboard<script>import { Notification20, UserAvatar20, AppSwitcher20 } from '@carbon/icons-vue';
export default {  name: "TutorialHeader",  components: { Notification20, UserAvatar20, AppSwitcher20 }};</script>
...
src/components/TutorialHeader/TutorialHeader.vueCopy to clipboard<template slot="header-global" />
...
src/components/TutorialHeader/TutorialHeader.vueCopy to clipboard<template slot="header-global">  <cv-header-global-action aria-label="Notifications">    <notification-20 />  </cv-header-global-action>  <cv-header-global-action aria-label="User avatar">    <user-avatar-20 />  </cv-header-global-action>  <cv-header-global-action aria-label="App switcher">    <app-switcher-20 />Show more
...
src/App.vueCopy to clipboard<script>import TutorialHeader from "./components/TutorialHeader";
export default {  name: "App",  components: {    TutorialHeader  }};Show more
...
src/App.vueCopy to clipboard<template>  <div id="app">    <tutorial-header />    <cv-content id="#main-content">      <cv-button>Button</cv-button>    </cv-content>  </div></template>
...
src/views├── LandingPage└── RepoPageCopy to clipboard
...
src/view/LandingPage├── index.js└── LandingPage.vueCopy to clipboard
...
src/view/RepoPage├── index.js└── RepoPage.vueCopy to clipboard
...
src/view/LandingPage/index.jsCopy to clipboardimport LandingPage from './LandingPage';export default LandingPage;
...
src/view/LandingPage/LandingPage.vueCopy to clipboard<template>  <div>LANDING PAGE</div></template>
...
src/view/RepoPage/index.jsCopy to clipboardimport RepoPage from './RepoPage';export default RepoPage;
...
src/view/RepoPage/RepoPage.vueCopy to clipboard<template>  <div>REPO PAGE</div></template>
...
src/router.jsCopy to clipboardimport Vue from 'vue';import Router from 'vue-router';import LandingPage from './views/LandingPage';
Vue.use(Router);
export default new Router({  routes: [    {Show more
...
src/App.vueCopy to clipboard<cv-content id="#main-content">  <router-view /></cv-content>
...
src/components/TutorialHeader/TutorialHeader.vueCopy to clipboard<cv-header-name to="/" prefix="IBM">Carbon Tutorial</cv-header-name>
...
<cv-header-menu-item to="/repos">Repositories</cv-header-menu-item>Copy to clipboard
...
git push origin vue-step-1Copy to clipboard
...
```javascript
<script>import { CvButton } from '@carbon/vue';
export default {  components: {    CvButton,  }};</script>
```
...
```html
<template>  <cv-header aria-label="Carbon tutorial">    <cv-skip-to-content href="#main-content"      >Skip to content</cv-skip-to-content    >
    <cv-header-name href="/" prefix="IBM">Carbon Tutorial</cv-header-name>
    <cv-header-nav>
```
...
```javascript
<script>import { Notification20, UserAvatar20, AppSwitcher20 } from '@carbon/icons-vue';
export default {  name: "TutorialHeader",  components: { Notification20, UserAvatar20, AppSwitcher20 }};</script>
```
...
export default {  name: "App",  components: {    TutorialHeader  }};
```
...
```javascript
import Vue from 'vue';import Router from 'vue-router';import LandingPage from './views/LandingPage';
Vue.use(Router);
