# Web components tutorial – Carbon Design System

Source: https://www.carbondesignsystem.com/developing/web-components-tutorial/overview/
...
- [Audience](https://carbondesignsystem.com/developing/web-components-tutorial/overview/#audience)

- [Prerequisites](https://carbondesignsystem.com/developing/web-components-tutorial/overview/#prerequisites)

- [Outline](https://carbondesignsystem.com/developing/web-components-tutorial/overview/#outline)
...
tutorial and go to the [developers getting started](https://carbondesignsystem.com/developing/get-started)
page.
...
1. [**Installing Carbon**](https://carbondesignsystem.com/developing/web-components-tutorial/step-1)

Create a web app with the UI shell component.

2. [**Building pages**](https://carbondesignsystem.com/developing/web-components-tutorial/step-2)

Build pages with the grid and various components.

3. [**Using APIs**](https://carbondesignsystem.com/developing/web-components-tutorial/step-3)

Populate the data table with an external data source.

4. [**Creating components**](https://carbondesignsystem.com/developing/web-components-tutorial/step-4)

Extend Carbon by creating your own components.

5. [**Deploying**](https://carbondesignsystem.com/developing/web-components-tutorial/step-5)
