...
Source: https://www.carbondesignsystem.com/developing/community-frameworks/other-frameworks/
...
- [Using just the styles](https://carbondesignsystem.com/developing/community-frameworks/other-frameworks/#using-just-the-styles)

- [Wrapping a component](https://carbondesignsystem.com/developing/community-frameworks/other-frameworks/#wrapping-a-component)

- [Examples](https://carbondesignsystem.com/developing/community-frameworks/other-frameworks/#examples)

- [Troubleshooting](https://carbondesignsystem.com/developing/community-frameworks/other-frameworks/#troubleshooting)

- [Other frameworks](https://carbondesignsystem.com/developing/community-frameworks/other-frameworks/#other-frameworks)

## Using just the styles

Developers wanting to build in different ways, follow the instructions for the
[Vanilla JS](https://carbondesignsystem.com/developing/frameworks/vanilla/) library to access the styles and
...
```javascript
class BXLoading extends HTMLElement {  // Called when this custom element gets into render tree  connectedCallback() {    // "this" here is "<bx-loading>" element    this.innerHTML =      '(e.g. snippet from http://carbondesignsystem.com/components/loading/code)';    this.loading = CarbonComponents.Loading.create(      this.querySelector('[data-loading]')    );
```
