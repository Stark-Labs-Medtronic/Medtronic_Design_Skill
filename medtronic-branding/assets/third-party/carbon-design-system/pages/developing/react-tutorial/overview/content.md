# React tutorial – Carbon Design System

Source: https://www.carbondesignsystem.com/developing/react-tutorial/overview/
...
- [Audience](https://carbondesignsystem.com/developing/react-tutorial/overview/#audience)

- [Prerequisites](https://carbondesignsystem.com/developing/react-tutorial/overview/#prerequisites)

- [Outline](https://carbondesignsystem.com/developing/react-tutorial/overview/#outline)
...
1. [**Installing Carbon**](https://carbondesignsystem.com/developing/react-tutorial/step-1)

Create a web app with the UI shell component.

2. [**Building pages**](https://carbondesignsystem.com/developing/react-tutorial/step-2)

Build out pages with the grid and various components.

3. [**Using APIs**](https://carbondesignsystem.com/developing/react-tutorial/step-3)

Populate the data table with an external data source.

4. [**Creating components**](https://carbondesignsystem.com/developing/react-tutorial/step-4)

Extend Carbon by creating your own components.

5. [**Deploying**](https://carbondesignsystem.com/developing/react-tutorial/step-5)
