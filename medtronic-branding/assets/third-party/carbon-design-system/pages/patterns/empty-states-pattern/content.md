...
Source: https://www.carbondesignsystem.com/patterns/empty-states-pattern/
...
- [Overview](https://carbondesignsystem.com/patterns/empty-states-pattern/#overview)

- [Anatomy](https://carbondesignsystem.com/patterns/empty-states-pattern/#anatomy)

- [Designing with empty states](https://carbondesignsystem.com/patterns/empty-states-pattern/#designing-with-empty-states)

- [Types of empty states](https://carbondesignsystem.com/patterns/empty-states-pattern/#types-of-empty-states)

- [In-depth alternatives](https://carbondesignsystem.com/patterns/empty-states-pattern/#in-depth-alternatives)

- [Accessibility](https://carbondesignsystem.com/patterns/empty-states-pattern/#accessibility)

- [Related](https://carbondesignsystem.com/patterns/empty-states-pattern/#related)

- [References](https://carbondesignsystem.com/patterns/empty-states-pattern/#references)

- [Feedback](https://carbondesignsystem.com/patterns/empty-states-pattern/#feedback)
...
4. **Primary action—button or link in copy (optional):** The primary call to
action referenced in the body copy above.

5. **Secondary call to action (optional):** If there is a secondary action, such
...
| User action empty states | Provides feedback based on some user action. For example: No results when searchingConfirmation of completion of a process | User understands how to adjust search terms or filters to continue their search. User understands that they’ve successfully completed a process. | User understands that they’ve successfully completed a process. When you need to provide feedback to the user based on an interaction. |
...
[guidelines for contributions](https://carbondesignsystem.com/contributing/pattern).
...
please see our [guidelines for contributions](https://carbondesignsystem.com/contributing/pattern).
