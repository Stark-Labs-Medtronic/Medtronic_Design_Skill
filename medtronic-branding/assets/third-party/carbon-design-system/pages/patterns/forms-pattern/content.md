...
Source: https://www.carbondesignsystem.com/patterns/forms-pattern/
...
- [Overview](https://carbondesignsystem.com/patterns/forms-pattern/#overview)

- [Building a form](https://carbondesignsystem.com/patterns/forms-pattern/#building-a-form)

- [Behavior](https://carbondesignsystem.com/patterns/forms-pattern/#behavior)

- [Designing a form](https://carbondesignsystem.com/patterns/forms-pattern/#designing-a-form)

- [Variants](https://carbondesignsystem.com/patterns/forms-pattern/#variants)

- [Accessibility](https://carbondesignsystem.com/patterns/forms-pattern/#accessibility)

- [Related](https://carbondesignsystem.com/patterns/forms-pattern/#related)

- [References](https://carbondesignsystem.com/patterns/forms-pattern/#references)

- [Feedback](https://carbondesignsystem.com/patterns/forms-pattern/#feedback)
...
[Designing for longer forms](https://carbondesignsystem.com/patterns/forms-pattern/#designing-for-longer-forms) section below.
...
3. **Data inputs:** Information can be entered through a variety of non-free
...
4. **Help:** Provides in-context guidance like tooltips, placeholder text, or
...
- Use the techniques illustrated below in the [Default Values](https://carbondesignsystem.com/patterns/forms-pattern/#default-values)
and [Designing for Longer Forms](https://carbondesignsystem.com/patterns/forms-pattern/#designing-for-longer-forms) sections in
...
| Password input | To collect private data by hiding the characters | Passwords, Social Security Numbers (SSN), PINs, credit card information |
...
component and offer more detailed information about [form variations](https://carbondesignsystem.com/patterns/forms-pattern/#variants)
below.
...
padding. See [button usage guidance](https://carbondesignsystem.com/components/button/usage) for more
information.
...
[button groups](https://carbondesignsystem.com/components/button/usage/#button-groups) guidance. Factors such
...
Do arrange primary and secondary buttons at the bottom of the form.

Do not top align primary and secondary action buttons in your layouts.
...
[progress indicator](https://carbondesignsystem.com/components/progress-indicator/usage) (vertical or
...
[2x Grid](https://carbondesignsystem.com/elements/2x-grid/overview) for more information.
...
dedicated-page forms can handle more complexity. See [form variants](https://carbondesignsystem.com/patterns/forms-pattern/#variants)
...
Do consider multistep forms when faced with a lot of inputs.

Do not overload the user with too many input controls at once, especially in modals.
...
- A [dialog pattern](https://carbondesignsystem.com/patterns/dialog-pattern) with more detailed guidance will
be released shortly.
...
- [Password input](https://carbondesignsystem.com/components/text-input/usage/#password-input)
