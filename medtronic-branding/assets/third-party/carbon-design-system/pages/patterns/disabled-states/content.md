# Disabled states – Carbon Design System

Source: https://www.carbondesignsystem.com/patterns/disabled-states/
...
- [Disabled variations](https://carbondesignsystem.com/patterns/disabled-states/#disabled-variations)

- [Default disabled](https://carbondesignsystem.com/patterns/disabled-states/#default-disabled)

- [Read-only](https://carbondesignsystem.com/patterns/disabled-states/#read-only)

- [Hidden](https://carbondesignsystem.com/patterns/disabled-states/#hidden)
...
| Read-only | The user cannot interact with it but content is still readable and accessible to a screen reader. The visual style should contain no interactive indicators such as $interactive-01, hover states, or text embellishments (i.e., underlines). |
...
An [inline warning notification](https://carbondesignsystem.com/components/notification/usage) can be shown in
