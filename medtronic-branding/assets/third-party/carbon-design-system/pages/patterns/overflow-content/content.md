...
Source: https://www.carbondesignsystem.com/patterns/overflow-content/
...
- [Usage](https://carbondesignsystem.com/patterns/overflow-content/#usage)

- [Variations](https://carbondesignsystem.com/patterns/overflow-content/#variations)

- [Code](https://carbondesignsystem.com/patterns/overflow-content/#code)

- [“Show more” buttons](https://carbondesignsystem.com/patterns/overflow-content/#%22show-more%22-buttons)
...
<div class="container">  <span title="123456789" class="cds--front-line">123456789</span></div>Copy to clipboard

```

```

.container {  width: 65px;}Copy to clipboard

```

```

.cds--front-line {  width: 100%;  display: inline-block;  direction: rtl;  text-overflow: ellipsis;  white-space: nowrap;  overflow: hidden;}Copy to clipboard
...
[Loading](https://carbondesignsystem.com/components/loading/usage) section for additional details.
...
```css
.cds--front-line {  width: 100%;  display: inline-block;  direction: rtl;  text-overflow: ellipsis;  white-space: nowrap;  overflow: hidden;}
```
